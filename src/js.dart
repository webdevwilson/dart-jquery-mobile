...
var d=\$(document);
d.load(function() {
  \$(['pagebeforecreate', 'pagechange', 'pagechangefailed']).each(function(k,v) { bounceJQMEvent(v); });
});

function bounceJQMEvent(name) {
  d.bind(name, function(e) {
    var evt = createEvent('jqm-dart-' + name, e);
...
function jqm_dart_invokeJQM(name,args) {
  return jQuery.mobile[name].apply(jQuery.mobile,args);
}
''';
